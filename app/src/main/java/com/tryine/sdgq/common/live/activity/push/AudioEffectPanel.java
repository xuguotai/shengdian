...
public class AudioEffectPanel extends FrameLayout {
    ...
    private List<ItemEntity> createAudioChangeItems() {
        ...
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_original), R.mipmap.audio_effect_setting_changetype_original_open, AUDIO_VOICECHANGER_TYPE_0));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_child), R.mipmap.audio_effect_setting_changetype_child, AUDIO_VOICECHANGER_TYPE_1));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_luoli), R.mipmap.audio_effect_setting_changetype_luoli, AUDIO_VOICECHANGER_TYPE_2));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_dashu), R.mipmap.audio_effect_setting_changetype_dashu, AUDIO_VOICECHANGER_TYPE_3));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_metal), R.mipmap.audio_effect_setting_changetype_metal, AUDIO_VOICECHANGER_TYPE_4));
//        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_sick), R.drawable.audio_effect_setting_changetype_sick, AUDIO_VOICECHANGER_TYPE_5));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_foreign), R.mipmap.audio_effect_setting_changetype_foreign, AUDIO_VOICECHANGER_TYPE_6));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_kunsou), R.mipmap.audio_effect_setting_changetype_kunsou, AUDIO_VOICECHANGER_TYPE_7));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_feizai), R.mipmap.audio_effect_setting_changetype_feizai, AUDIO_VOICECHANGER_TYPE_8));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_dianliu), R.mipmap.audio_effect_setting_changetype_dianliu, AUDIO_VOICECHANGER_TYPE_9));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_machine), R.mipmap.audio_effect_setting_changetype_machine, AUDIO_VOICECHANGER_TYPE_10));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_changetype_kongling), R.mipmap.audio_effect_setting_changetype_kongling, AUDIO_VOICECHANGER_TYPE_11));
    ...
    private List<ItemEntity> createReverbItems() {
        List<ItemEntity> list = new ArrayList<>();
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_origin), R.mipmap.audio_effect_setting_reverbtype_origin_high, AUDIO_REVERB_TYPE_0));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_ktv), R.mipmap.audio_effect_setting_reverbtype_ktv, AUDIO_REVERB_TYPE_1));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_room), R.mipmap.audio_effect_setting_reverbtype_room, AUDIO_REVERB_TYPE_2));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_meeting), R.mipmap.audio_effect_setting_reverbtype_meeting, AUDIO_REVERB_TYPE_3));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_lowdeep), R.mipmap.audio_effect_setting_reverbtype_lowdeep, AUDIO_REVERB_TYPE_4));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_hongliang), R.mipmap.audio_effect_setting_reverbtype_hongliang, AUDIO_REVERB_TYPE_5));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_heavymetal), R.mipmap.audio_effect_setting_reverbtype_heavymetal, AUDIO_REVERB_TYPE_6));
        list.add(new ItemEntity(getResources().getString(R.string.audio_effect_setting_reverbtype_cixing), R.mipmap.audio_effect_setting_reverbtype_cixing, AUDIO_REVERB_TYPE_7));
        list.get(0).mIsSelected = true;
        return list;
    }
    ...
    private List<BGMItemEntity> createBGMItems() {
        ...
        list.add(new BGMItemEntity("环绕声1", ONLINE_BGM_FIRST, getResources().getString(R.string.audio_effect_setting_unknown)));
        list.add(new BGMItemEntity("环绕声2", ONLINE_BGM_SECOND, getResources().getString(R.string.audio_effect_setting_unknown)));
        return list;
    }
    ...
    public class BGMRecyclerViewAdapter extends
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final BGMItemEntity model, final int positon,
                             final OnItemClickListener listener) {
                mItemImg.setImageResource(R.mipmap.audio_effect_setting_bgm_play);
                mTitleTv.setText(model.mTitle);
...
//            Log.d(TAG, "onPlayProgress id " + id + ", curPtsMS = " + curPtsMS + ", durationMS " + durationMS);
        ...
        public void onComplete(int id, int i1) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mImgbtnBGMPlay.setImageResource(R.mipmap.audio_effect_setting_bgm_play);
                    mIsPlayEnd = true;
                }
            });
        }
    ...
    public void resumeBGM() {
        ...
        if (!mIsPlayEnd && !mIsPlaying && !mIsPause) {
            ...
            mImgbtnBGMPlay.setImageResource(R.mipmap.audio_effect_setting_bgm_pause);
            mIsPlaying = true;
        }
    }
