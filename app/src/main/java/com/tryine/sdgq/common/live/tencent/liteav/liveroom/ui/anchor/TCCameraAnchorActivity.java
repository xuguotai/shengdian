package com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.anchor;
...
import com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.widget.AudioEffectPanel;
import com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.widget.feature.FeatureSettingDialog;
import com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.widget.video.TCVideoView;
import com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.widget.video.TCVideoViewMgr;
 ...
 * <p>
 */
public class TCCameraAnchorActivity extends TCBaseAnchorActivity implements View.OnClickListener, LiveInView {
...
//        mPanelBeautyControl.setBeautyManager(mLiveRoom.getBeautyManager());
    ...
    protected void initView() {
        super.initView();
        mRoomId = getIntent().getIntExtra("mRoomId", 0);
        ...
        mButtonPK.setVisibility(View.GONE);
        //AudioEffectPanel
...
//        });
    ...
    @Override
    protected void enterRoom(int mRoomId) {
        super.enterRoom(mRoomId);
    }
...
//
        mLivePusher.setRenderView(mTXCloudVideoView);
        mLivePusher.startCamera(isCamera);
    ...
    @Override
    protected void oncloseRoomSuccess() {
        closeRoom();
    }
...
//            }
    ...
    protected void onResume() {
        ...
        mIsPaused = false;
        //向全班观众发布一条通知，我回来了
        mLiveRoom.sendRoomCustomMsg(String.valueOf(TCConstants.BACK), SPUtils.getString(Parameter.USER_ID), new TRTCLiveRoomCallback.ActionCallback() {
            @Override
            public void onCallback(int code, String msg) {
    ...
    protected void onPause() {
        super.onPause();
        mIsPaused = true;
        //向全班观众发布一条通知，我离开了(APP退到了后台)
        mLiveRoom.sendRoomCustomMsg(String.valueOf(TCConstants.LEAVE), SPUtils.getString(Parameter.USER_ID), new TRTCLiveRoomCallback.ActionCallback() {
            @Override
            public void onCallback(int code, String msg) {
