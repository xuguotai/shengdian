 ...
 */
public class MineCourseHomeActivity extends BaseActivity {
    ...
    public static void start(Context context) {
        ...
        intent.setClass(context, MineCourseHomeActivity.class);
        context.startActivity(intent);
    }

    @Override
    public int getLayoutId() {
        return R.layout.activity_minecoursehome;
    }
    ...
    protected void init() {
        ...
        MineOnlineCourseFragment fragment = new MineOnlineCourseFragment();
        MineofflineCourseFragment fragment1 = new MineofflineCourseFragment();
    ...
    private MineOnlineCourseFragment createFansListFragments(String type) {
        MineOnlineCourseFragment fragment = new MineOnlineCourseFragment();
