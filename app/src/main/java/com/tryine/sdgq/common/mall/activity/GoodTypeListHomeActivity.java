...
import com.tryine.sdgq.common.mall.fragment.GoodTypeFragment;
 ...
 */
public class GoodTypeListHomeActivity extends BaseActivity {
    ...
    public static void start(Context context, int type) {
        ...
        intent.setClass(context, GoodTypeListHomeActivity.class);
    ...
    private GoodTypeFragment createFragments(String status) {
        GoodTypeFragment fragment = new GoodTypeFragment();
