 ...
 * tab
 */
public class TeacherTabAdapter extends BaseQuickAdapter<String, BaseViewHolder> {

    int selectedTabPosition = 0;

    public TeacherTabAdapter(Context context, List<String> data) {
        super(R.layout.item_tab_teacher, data);
        mContext = context;
    }
