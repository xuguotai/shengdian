 ...
 */
public class CancelReserveCourseActivity extends BaseActivity implements CourseView {
    ...
    public static void start(Context context, String courseId, String addrDes) {
        ...
        intent.setClass(context, CancelReserveCourseActivity.class);
    ...
    public int getLayoutId() {
        return R.layout.activity_course_reserve_cancel;
    }
    ...
    protected void initViews() {
        ...
        courseReserveListAdapter = new CourseReserveListAdapter(this, courseBeanLists, "1",addrDes);
    ...
    private void smartRefresh() {
        ...
        slRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                pageNum = 1;
                coursePresenter.getCancelhavelist(courseId, pageNum);
            }
        });
        //上拉加载
