 ...
 */
public class CampusTeacherAdapter extends BaseQuickAdapter<TeacherBean, BaseViewHolder> {

    public CampusTeacherAdapter(Context context, List<TeacherBean> data) {
        super(R.layout.item_campus_teacher, data);
        mContext = context;
    }
