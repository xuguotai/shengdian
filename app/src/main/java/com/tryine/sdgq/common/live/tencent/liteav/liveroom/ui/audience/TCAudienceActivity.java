package com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.audience;
...
import com.tryine.sdgq.common.live.tencent.liteav.demo.beauty.BeautyParams;
...
import com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.widget.like.TCHeartLayout;
...
public class TCAudienceActivity extends AppCompatActivity implements View.OnClickListener, InputTextMsgDialog.OnTextSendListener {
    ...
    private TextView tv_kcname;        // 课程章节
...
//            showErrorAndQuit(0, getString(R.string.trtcliveroom_warning_room_disband));
            PromptDialog promptDialog = new PromptDialog(TCAudienceActivity.this, 0, "提示",
                    "老师已下播", "确认", "");
            promptDialog.show();
...
//            if (userId.equals(mAnchorId)) {
//                ToastUtil.toastLongMessage("5555555555555");
...
//            }
        ...
        public void onRecvRoomCustomMsg(String cmd, String message, TRTCLiveRoomDef.TRTCLiveUserInfo userInfo) {
            ...
            switch (type) {
                ...
                case TCConstants.IMCMD_DANMU:
                    ...
                    break;
                case TCConstants.LEAVE: // 主播离开
                    if (message.equals(mAnchorId)) {
                        mIsAnchorEnter = false;
                        if (mTextAnchorLeave != null) {
                            mVideoViewAnchor.setVisibility(View.GONE);
                            mImageBackground.setVisibility(View.VISIBLE);
                            mTextAnchorLeave.setVisibility(View.VISIBLE);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userId = intent.getStringExtra(TCConstants.USER_ID);
        ...
        kcName = intent.getStringExtra(TCConstants.KECHENG_NAME);
        ...
        LiveInPresenter liveInPresenter = new LiveInPresenter(this);
//        liveInPresenter.countroominfo(mRoomId,0);
    ...
    private void initView() {
        ...
        tv_kcname = (TextView) findViewById(R.id.tv_kcname);
        ...
        TCUtils.showPicWithUrl(TCAudienceActivity.this
                , mImageBackground, mCoverUrl, R.mipmap.trtcliveroom_bg_cover);
...
//        mBeautyControl.setBeautyManager(mLiveRoom.getBeautyManager());
        ...
        TCUtils.showPicWithUrl(TCAudienceActivity.this, mImageAnchorAvatar, mAnchorAvatarURL, R.mipmap.trtcliveroom_bg_cover);
