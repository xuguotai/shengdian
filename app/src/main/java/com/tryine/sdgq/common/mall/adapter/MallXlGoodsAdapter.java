 ...
 * 商城首页限量商品
 */
public class MallXlGoodsAdapter extends BaseQuickAdapter<GoodsBean, BaseViewHolder> {

    public MallXlGoodsAdapter(Context context, List<GoodsBean> data) {
        super(R.layout.item_mall_xlgoods, data);
        mContext = context;
    }
