...
//        }
    ...
    public void opencreateRoom(int mRoomId) {
        mRoomName = mSelfName;
        createRoom(mRoomId);
    }

    private void createRoom(int mRoomId) {
...
//                    showErrorAndQuit(code, getString(R.string.trtcliveroom_error_create_live_room, msg));
                    showErrorAndQuit(code, "创建直播房间失败,重新启动APP");
                }
    ...
    protected abstract void oncloseRoomSuccess();
