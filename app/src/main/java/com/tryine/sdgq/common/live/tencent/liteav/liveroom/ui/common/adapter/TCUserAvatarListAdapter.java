package com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.common.adapter;
...
public class TCUserAvatarListAdapter extends RecyclerView.Adapter<TCUserAvatarListAdapter.AvatarViewHolder> {
    ...
    public void onBindViewHolder(AvatarViewHolder holder, int position) {
        ...
        if (info != null) {
            TCUtils.showPicWithUrl(mContext, holder.ivAvatar, info.userAvatar, R.mipmap.trtcliveroom_bg_cover);
        }
    }
