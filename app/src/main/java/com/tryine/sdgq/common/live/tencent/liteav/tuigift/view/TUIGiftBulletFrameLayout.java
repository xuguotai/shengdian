...
public class TUIGiftBulletFrameLayout extends FrameLayout implements Handler.Callback {
    ...
    private static final int GIFT_DISMISS_TIME   = 30000; //礼物展示时间
    ...
    private void initView() {
        ...
        mGiftGroup.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                PersonalHomePageActivity.start(mContext,mGiftModel.extInfo.get(TUIGiftConstants.KEY_USER_ID));
            }
        });
    }
    ...
    private void initLayoutState() {
        ...
        TUIImageLoader.loadImage(mContext, mImageSendUserIcon, mGiftModel.extInfo.get(TUIGiftConstants.KEY_USER_AVATAR), R.mipmap.ic_default_head);
        TUIImageLoader.loadImage(mContext, mImageGiftIcon, mGiftModel.normalImageUrl, R.mipmap.ic_default_head);
    }
