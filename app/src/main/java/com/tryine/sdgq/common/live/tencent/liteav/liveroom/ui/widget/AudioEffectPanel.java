...
public class AudioEffectPanel extends BottomSheetDialog {
    ...
    private List<ItemEntity> createAudioChangeItems() {
        ...
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_no_effect), R.mipmap.trtcliveroom_no_select_normal, R.mipmap.trtcliveroom_no_select_hover, AUDIO_VOICECHANGER_TYPE_0));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_change_type_child), R.mipmap.trtcliveroom_changetype_child_normal,  R.mipmap.trtcliveroom_changetype_child_hover, AUDIO_VOICECHANGER_TYPE_1));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_change_type_luoli), R.mipmap.trtcliveroom_changetype_luoli_normal, R.mipmap.trtcliveroom_changetype_luoli_hover, AUDIO_VOICECHANGER_TYPE_2));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_change_type_dashu), R.mipmap.trtcliveroom_changetype_dashu_normal, R.mipmap.trtcliveroom_changetype_dashu_hover, AUDIO_VOICECHANGER_TYPE_3));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_change_type_kongling), R.mipmap.trtcliveroom_reverbtype_kongling_normal, R.mipmap.trtcliveroom_reverbtype_kongling_hover, AUDIO_VOICECHANGER_TYPE_11));
        return list;
    }

    private List<ItemEntity> createReverbItems() {
        List<ItemEntity> list = new ArrayList<>();
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_no_effect), R.mipmap.trtcliveroom_no_select_normal, R.mipmap.trtcliveroom_no_select_hover, AUDIO_REVERB_TYPE_0));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_reverb_type_ktv), R.mipmap.trtcliveroom_reverbtype_ktv_normal, R.mipmap.trtcliveroom_reverbtype_ktv_hover, AUDIO_REVERB_TYPE_1));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_reverb_type_lowdeep), R.mipmap.trtcliveroom_reverbtype_lowdeep_normal, R.mipmap.trtcliveroom_reverbtype_lowdeep_hover, AUDIO_REVERB_TYPE_4));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_reverb_type_heavymetal), R.mipmap.trtcliveroom_reverbtype_heavymetal_normal, R.mipmap.trtcliveroom_reverbtype_heavymetal_hover, AUDIO_REVERB_TYPE_6));
        list.add(new ItemEntity(mContext.getResources().getString(R.string.trtcliveroom_audio_reverb_type_hongliang), R.mipmap.trtcliveroom_reverbtype_hongliang_normal, R.mipmap.trtcliveroom_reverbtype_hongliang_hover, AUDIO_REVERB_TYPE_5));
        return list;
    }
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(final ItemEntity model, final int position,
                ...
                if (model.mIsSelected) {
                    ...
                    mItemImg.setImageResource(model.mIconId);
                    mTitleTv.setTextColor(mContext.getResources().getColor(R.color.trtcliveroom_color_dark_black));
                }
        ...
        public void onComplete(int id, int i1) {
            ...
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    mImgbtnBGMPlay.setImageResource(R.mipmap.trtcliveroom_bgm_play);
                    mIsPlayEnd = true;
                }
            });
        }
    ...
    public void resumeBGM() {
        ...
        if (!mIsPlayEnd && !mIsPlaying && !mIsPause) {
            ...
            mImgbtnBGMPlay.setImageResource(R.mipmap.trtcliveroom_bgm_pause);
            mIsPlaying = true;
        }
    }
