 ...
 */
package com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.widget.like;
...
public class TCHeartLayout extends RelativeLayout {
    ...
    private void findViewById(Context context) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.trtcliveroom_icon_like_png);
    ...
    private static int[]            drawableIds = new int[]{R.mipmap.trtcliveroom_heart0, R.mipmap.trtcliveroom_heart1, R.mipmap.trtcliveroom_heart2, R.mipmap.trtcliveroom_heart3, R.mipmap.trtcliveroom_heart4, R.mipmap.trtcliveroom_heart5, R.mipmap.trtcliveroom_heart6, R.mipmap.trtcliveroom_heart7, R.mipmap.trtcliveroom_heart8,};
