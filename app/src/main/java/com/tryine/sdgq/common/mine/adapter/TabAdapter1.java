 ...
 * tab
 */
public class TabAdapter1 extends BaseQuickAdapter<HomeMenuBean, BaseViewHolder> {

    int selectedTabPosition = 0;

    public TabAdapter1(Context context, List<HomeMenuBean> data) {
        super(R.layout.item_tab1, data);
        mContext = context;
    }
