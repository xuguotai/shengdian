 ...
 */
public class FansListFragment extends BaseFragment implements MineView {
        ...
        fansAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if (view.getId() == R.id.ll_root) {
                    ...
                    minePresenter.setFocus(fansBeanLists.get(position).getUserId(), "1");
                }
            }
        });
    ...
    private void smartRefresh() {
        ...
        slRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(@NonNull RefreshLayout refreshLayout) {
                pageNum = 1;
                minePresenter.getFocusList(pageNum, userId, selectType);
