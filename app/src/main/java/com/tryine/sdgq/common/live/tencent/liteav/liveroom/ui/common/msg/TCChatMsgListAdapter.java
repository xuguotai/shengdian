package com.tryine.sdgq.common.live.tencent.liteav.liveroom.ui.common.msg;
...
public class TCChatMsgListAdapter extends BaseAdapter implements AbsListView.OnScrollListener {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.tv_dj = (GradeTextView) convertView.findViewById(R.id.tv_dj);
        ...
        String result = item.getSenderName();
        ...
        if (item.getContent().contains("!#!")) {
            ...
            try {
                holder.tv_dj.setData(Integer.parseInt(contents[1]));
                holder.tv_dj.setVisibility(View.VISIBLE);
                if (contents[2].equals("0")) {
                    holder.iv_vip.setVisibility(View.GONE);
                } else {
                    holder.iv_vip.setVisibility(View.VISIBLE);
                }
                holder.sendContext.setText("：" + contents[0]);
            } catch (Exception e) {
                holder.tv_dj.setVisibility(View.GONE);
            }
        } else {
        ...
        holder.tv_name.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    if (item.getContent().contains("!#!")) {
                        PersonalHomePageActivity.start(mContext, item.getContent().split("!#!")[3]);
                    }
                } catch (Exception e) {
                    holder.tv_dj.setVisibility(View.GONE);
                }
