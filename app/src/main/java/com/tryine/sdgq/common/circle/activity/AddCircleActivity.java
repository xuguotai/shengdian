 ...
 * @time: 2021-12-02 09:57
 */
public class AddCircleActivity extends BaseActivity implements TXUGCPublishTypeDef.ITXVideoPublishListener, CircleView {
    ...
    @BindView(R.id.iv_close_ht)
    ImageView iv_close_ht;
    @BindView(R.id.iv_close_hd)
    ImageView iv_close_hd;
    ...
    List<HomeMenuBean> topicList = new ArrayList<>();
    String topicId;
    List<HomeMenuBean> hdList = new ArrayList<>();
    String hdId;
    ...
    int resourceType = 0;//0首次全部可以选 1图片 2视频
    ...
    public static void start(Context context) {
        ...
        intent.setClass(context, AddCircleActivity.class);
    ...
    @OnClick({R.id.iv_black, R.id.ll_submit, R.id.ll_ht, R.id.ll_hd, R.id.tv_cancel, R.id.iv_coverUrl, R.id.iv_close_ht, R.id.iv_close_hd})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.iv_black:
                finish();
            ...
            case R.id.iv_coverUrl: //封面
                ...
                break;
            case R.id.ll_ht://关联话题
                if (null != topicList) {
                    VideoTypeDialog videoTypeDialog = new VideoTypeDialog(this, topicList);
                    ...
                    videoTypeDialog.setOnItemClickListener(new VideoTypeDialog.OnItemClickListener() {
                        ...
                        public void resultReason(HomeMenuBean homeMenuBean) {
                            topicId = homeMenuBean.getId();
                            tv_topicTitle.setText(homeMenuBean.getName());
                            iv_close_ht.setVisibility(View.VISIBLE);
                        }
                    });
                }
                break;
            case R.id.ll_hd:// 关联活动
                if (null != hdList) {
                    VideoTypeDialog videoTypeDialog = new VideoTypeDialog(this, hdList);
                    videoTypeDialog.show();
                    videoTypeDialog.setOnItemClickListener(new VideoTypeDialog.OnItemClickListener() {
                        @Override
                        public void resultReason(HomeMenuBean homeMenuBean) {
                            hdId = homeMenuBean.getId();
                            tv_activity.setText(homeMenuBean.getName());
                            iv_close_hd.setVisibility(View.VISIBLE);
                        }
                    });
                }
                break;
            case R.id.ll_submit:
                submit();
                break;
            case R.id.iv_close_ht:
                iv_close_ht.setVisibility(View.GONE);
                tv_topicTitle.setText("");
                topicId = "";
                break;
            case R.id.iv_close_hd:
                iv_close_hd.setVisibility(View.GONE);
                tv_activity.setText("");
                hdId = "";
                break;
    ...
    private void addFoot() {
        ...
        try {
            ...
            circlePresenter.addpublishtopic(obj);
