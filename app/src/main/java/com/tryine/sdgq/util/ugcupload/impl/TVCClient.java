package com.tryine.sdgq.util.ugcupload.impl;
...
import com.tryine.sdgq.util.ugcupload.impl.compute.TXHttpTaskMetrics;
import com.tryine.sdgq.util.ugcupload.impl.compute.TXOnGetHttpTaskMetrics;
...
public class TVCClient {
    ...
    public boolean isResumeUploadVideo() {
        if (enableResume
                ...
                && uploadInfo != null
                && fileLastModTime != 0 && fileLastModTime == uploadInfo.getFileLastModifyTime()
                && coverFileLastModTime != 0 && coverFileLastModTime == uploadInfo.getCoverLastModifyTime()) {
            return true;
        }
        return false;
    }
