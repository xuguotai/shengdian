...
public class BannerCourseViewPager extends RelativeLayout implements ViewPager.OnPageChangeListener {
    private View mLayout;//布局
    private Activity mContext;//上下文
    private ViewPager mViewPager;//viewpager
    private BannerCoursePagerAdapter mPagerAdapter;//adapter
    private LinearLayout mLineIndicator;//指示器集合容器
    private ImageView[] mImageView;//小圆点imageview对象
    private List<CourseBean> mList;//url数组
    ...
    private BannerCourseViewPager.OnClickBannerListener mBannerListener;

    public BannerCourseViewPager addBannerListener(BannerCourseViewPager.OnClickBannerListener listener) {
    ...
    private BannerCourseViewPager.OnPageSelectedListener mBannerPageSelectedListener;

    public BannerCourseViewPager addOnPageSelected(BannerCourseViewPager.OnPageSelectedListener listener) {
...
//        }
//    };
    public BannerCourseViewPager(Context context) {
        super(context);
    }

    public BannerCourseViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public BannerCourseViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public BannerCourseViewPager initBanner(List<CourseBean> list, boolean isGallery) {
        mList = list;
        //引入布局
        mLayout = LayoutInflater.from(mContext).inflate(R.layout.banner_view_course_layout, null);
        ...
        //初始化位置
        mPagerAdapter = new BannerCoursePagerAdapter(mList, mContext);
        mPagerAdapter.setOnClickImagesListener(new BannerCoursePagerAdapter.OnClickImagesListener() {
            @Override
     ...
     * @param alpha     滑动透明度变化
     */
    public BannerCourseViewPager initBanner(List<CourseBean> list, boolean isGallery, float alpha) {
        mList = list;
     ...
     * @return
     */
    public BannerCourseViewPager addDefaultImg(int resId_img) {
     ...
     * @return
     */
    public BannerCourseViewPager addRoundCorners(int corners) {
     ...
     */
    public BannerCourseViewPager addPageMargin(int columnMargin, int rowMargin) {
     ...
     * @param distance 间距
     */
    public BannerCourseViewPager addPoint(int distance) {
        isPoint = true;
     ...
     * @param piont       替换未选中图片
     */
    public BannerCourseViewPager addPoint(int distance, int piont_press, int piont) {
        isPoint = true;
     ...
     * @param paddBottom
     */
    public BannerCourseViewPager addPointBottom(int paddBottom) {
     ...
     * 配置完成,将布局添加到父容器
     */
    public BannerCourseViewPager finishConfig() {
        this.addView(mLayout);
        return this;
    }

    //开始轮播
    public BannerCourseViewPager addStartTimer(int time) {
        mRollTime = time;
        if (mHandler == null) {
