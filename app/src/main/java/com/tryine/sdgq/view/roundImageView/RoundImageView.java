package com.tryine.sdgq.view.roundImageView;
...
public class RoundImageView extends AppCompatImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCornerRadii[Corner.TOP_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundImageView_corner_top_left_radius, -1);
        mCornerRadii[Corner.TOP_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundImageView_corner_top_right_radius, -1);
        mCornerRadii[Corner.BOTTOM_RIGHT] =
                a.getDimensionPixelSize(R.styleable.RoundImageView_corner_bottom_right_radius, -1);
        mCornerRadii[Corner.BOTTOM_LEFT] =
                a.getDimensionPixelSize(R.styleable.RoundImageView_corner_bottom_left_radius, -1);
        ...
        mMutateBackground = a.getBoolean(R.styleable.RoundImageView_is_cover_src, false);
        mIsOval = a.getBoolean(R.styleable.RoundImageView_is_circle, false);

        final int tileMode = TILE_MODE_UNDEFINED;//a.getInt(R.styleable.RoundedImageView_riv_tile_mode, TILE_MODE_UNDEFINED);
        if (tileMode != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileMode));
            setTileModeY(parseTileMode(tileMode));
        }

        final int tileModeX =TILE_MODE_UNDEFINED;//  a.getInt(R.styleable.RoundedImageView_riv_tile_mode_x, TILE_MODE_UNDEFINED);
        if (tileModeX != TILE_MODE_UNDEFINED) {
            setTileModeX(parseTileMode(tileModeX));
        }

        final int tileModeY =TILE_MODE_UNDEFINED;// a.getInt(R.styleable.RoundedImageView_riv_tile_mode_y, TILE_MODE_UNDEFINED);
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
        topLeft = SizeUtils.dp2px(topLeft);
        topRight = SizeUtils.dp2px(topRight);
        bottomLeft = SizeUtils.dp2px(bottomLeft);
        bottomRight = SizeUtils.dp2px(bottomRight);
