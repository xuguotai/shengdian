...
public class BannerHomeVideoViewPager extends RelativeLayout implements ViewPager.OnPageChangeListener {
    private View mLayout;//布局
    private Activity mContext;//上下文
    private ViewPager mViewPager;//viewpager
    private BannerHomeVideoPagerAdapter mPagerAdapter;//adapter
    private LinearLayout mLineIndicator;//指示器集合容器
    private ImageView[] mImageView;//小圆点imageview对象
    private List<BannerBean> mList;//url数组
    ...
    private BannerHomeVideoViewPager.OnClickBannerListener mBannerListener;

    public BannerHomeVideoViewPager addBannerListener(BannerHomeVideoViewPager.OnClickBannerListener listener) {
    ...
    private BannerHomeVideoViewPager.OnPageSelectedListener mBannerPageSelectedListener;

    public BannerHomeVideoViewPager addOnPageSelected(BannerHomeVideoViewPager.OnPageSelectedListener listener) {
...
//        }
//    };
    public BannerHomeVideoViewPager(Context context) {
        super(context);
    }

    public BannerHomeVideoViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public BannerHomeVideoViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     */
    public BannerHomeVideoViewPager initBanner(List<BannerBean> list, boolean isGallery) {
        mList = list;
        //引入布局
        ...
        mPagerAdapter = new BannerHomeVideoPagerAdapter(mList, mContext);
        mPagerAdapter.setOnClickImagesListener(new BannerHomeVideoPagerAdapter.OnClickImagesListener() {
            @Override
     ...
     * @param alpha     滑动透明度变化
     */
    public BannerHomeVideoViewPager initBanner(List<BannerBean> list, boolean isGallery, float alpha) {
        mList = list;
     ...
     * @return
     */
    public BannerHomeVideoViewPager addDefaultImg(int resId_img) {
     ...
     * @return
     */
    public BannerHomeVideoViewPager addRoundCorners(int corners) {
     ...
     */
    public BannerHomeVideoViewPager addPageMargin(int columnMargin, int rowMargin) {
     ...
     * @param distance 间距
     */
    public BannerHomeVideoViewPager addPoint(int distance) {
        isPoint = true;
     ...
     * @param piont       替换未选中图片
     */
    public BannerHomeVideoViewPager addPoint(int distance, int piont_press, int piont) {
        isPoint = true;
     ...
     * @param paddBottom
     */
    public BannerHomeVideoViewPager addPointBottom(int paddBottom) {
     ...
     * 配置完成,将布局添加到父容器
     */
    public BannerHomeVideoViewPager finishConfig() {
        this.addView(mLayout);
        return this;
    }

    //开始轮播
    public BannerHomeVideoViewPager addStartTimer(int time) {
        mRollTime = time;
        if (mHandler == null) {
