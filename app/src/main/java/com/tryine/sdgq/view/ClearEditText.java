...
public class ClearEditText extends EditText implements OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        if (mClearDrawable == null) {
            mClearDrawable = getResources().getDrawable(R.mipmap.ic_empty);
        }
    ...
    public void setHint(String hit) {
        setHint(Html.fromHtml("<font color=\"#A4A4A4\"><small>" + hit + "</small></font>"));
    }
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (null != focusChangeCallback) {
            focusChangeCallback.onFocusChange(hasFoucs);
        }
    ...
    public void afterTextChanged(Editable s) {
        if (null != editableCallback) {
            editableCallback.editableNull(this.getText().toString().trim());
        }
    }
    ...
    public interface EditableCallback {
        ...
        void editableNull(String conten);
    }

    public interface FocusChangeCallback {
        void onFocusChange(Boolean hasFoucs);
    }
}