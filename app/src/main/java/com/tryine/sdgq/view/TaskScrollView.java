...
public class TaskScrollView extends TextSwitcher {
    ...
    public TaskScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void start(List<TaskBean> list) {
        mDataList = list;
    ...
    private void show(int index) {
        ...
        setText(Html.fromHtml(mDataList.get(mIndex).getName() + "," + mDataList.get(mIndex).getRuleRemark()));
    }
