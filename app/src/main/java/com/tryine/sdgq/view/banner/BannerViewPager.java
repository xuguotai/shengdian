...
public class BannerViewPager extends RelativeLayout implements ViewPager.OnPageChangeListener {
    ...
    private BannerViewPager.OnClickBannerListener mBannerListener;

    public BannerViewPager addBannerListener(BannerViewPager.OnClickBannerListener listener) {
    ...
    private BannerViewPager.OnPageSelectedListener mBannerPageSelectedListener;

    public BannerViewPager addOnPageSelected(BannerViewPager.OnPageSelectedListener listener) {
...
//    };
     ...
     */
    public BannerViewPager initBanner(List<BannerBean> list, boolean isGallery) {
        mList = list;
        //引入布局
     ...
     * @param alpha     滑动透明度变化
     */
    public BannerViewPager initBanner(List<BannerBean> list, boolean isGallery, float alpha) {
        mList = list;
