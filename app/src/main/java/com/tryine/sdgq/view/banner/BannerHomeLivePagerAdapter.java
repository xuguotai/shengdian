...
public class BannerHomeLivePagerAdapter extends PagerAdapter {
    ...
    public BannerHomeLivePagerAdapter(List<LiveBean> list, Activity context) {
        this.mList = list;
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        View view = null;
        view = LayoutInflater.from(mContext).inflate(R.layout.banner_live_img_layout, container, false);
        ImageView imageView = (ImageView) view.findViewById(R.id.img);
        TextView tv_liveStatus = (TextView) view.findViewById(R.id.tv_liveStatus);
        if (mList.get(index).getLiveStatus().equals("1")) {
